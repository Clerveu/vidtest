...
def main():
    ...
    print("  6. Generate analysis file")
    print()
    ...
    print_step(2, 6, "EXTRACT SUBTITLES")
    SUBTITLES_DIR.mkdir(exist_ok=True)
    ...
    print_step(4, 6, "PROCESS WITH QWEN")
    if not process_chunks(prefix, api_key):
        print("  Processing failed.")
        return

    # STEP 5: Combine outputs
    print_step(5, 6, "COMBINE OUTPUTS")
